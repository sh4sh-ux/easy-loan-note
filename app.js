...
function buildContractHtml() {
  ...
  clauses.push([
    "조기상환과 완납 확인",
    `<p>채무자는 상환기일 전이라도 원금의 전부 또는 일부를 미리 상환할 수 있으며, 중도상환수수료는 없습니다.${
      hasInterest ? " 이후의 이자는 미상환 원금을 기준으로 계산합니다." : ""
    }</p>
     <p>채무자가 상환기일 전에 원금 일부를 상환한 경우, 미상환 원금은 실제 상환한 금액만큼 줄어듭니다. 상환기일이 지난 후 일부 금액을 지급한 경우에는 관계 법령상 인정되는 변제비용, 지연손해금, 원금의 순서로 충당하며, 원금에 충당된 금액만큼 미상환 원금이 줄어듭니다. 지연손해금은 남은 미상환 원금을 기준으로 계산합니다.</p>
